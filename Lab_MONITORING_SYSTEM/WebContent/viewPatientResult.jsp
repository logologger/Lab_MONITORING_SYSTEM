...
<title>Patients registered By HCP</title>
</head>
<%
...
<div class="col-md-4 input-group"style="margin:5px">
	<table>
		...
		<tr>
		<td><input type="text" name="search" class="form-control" placeholder="Patient Id"></td>
		<td><input type="submit" class="btn btn-success "value="Update"><input type="hidden" name="action" value="UpdateNewPatientProfile"></td></tr>	
		</form>
	</table>
	</div>
...
HttpSession se=request.getSession();
		ArrayList<Patient> patientList = (ArrayList<Patient>) se.getAttribute("patientList1");
