			...
			<nav class="navbar-inverse navbar-fixed-top  " role="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-right">
						<li><h4><span class="label label-success">Welcome <%=hcpatid%> !!</span></h4></li>
						<li>
...
<div class="row">
	...
	<input type="button" class="btn btn-info" value="Sort the Test based on the Cost">
...
arsearch=(ArrayList<Search_bean>)request.getAttribute("vt");
...
if(name.equals(s.getLab_service_provider_name()))
{
...
else
{
 ...
 name=s.getLab_service_provider_name();
	%>
	</td>
	<td>
	<% 
